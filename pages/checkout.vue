<template>
    <div>
        <div class="checkout" v-if="!order_confirm">
            <div class="row">
                <div class="col-lg-12">
            ...
            <form @submit.prevent="order" @keydown="form.onKeydown($event)" v-if="cart.length>0">
                <div class="row">
        ...
        <div v-else>
            <div class="row">
                <div class="col-lg-12">
                    <card title="Your order">
                        <p class="text-center">
                            Your order has been successfully created!<br/> Order number: #<b>{{order_number}}</b>.
                        </p>
                    </card>
                </div>
            </div>
        ...
        methods:{
            ...
            async getCart()
            {
                if(this.inCart.length>0)
                {
                    ...
                    this.$set(this, 'cart', []);
                    this.$set(this, 'prods_total', 0);
                    this.$set(this, 'prods_total_format', 0);
                }
            }
        },
        watch: {
